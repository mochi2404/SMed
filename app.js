...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    try {
      render();
      showToast("Data database belum bisa dimuat. Mode lokal aktif.");
    } catch (renderError) {
      console.error("Failed to render fallback app", renderError);
    }
  } finally {
    finishInitialLoad();
  }
...
function finishInitialLoad() {
  window.clearTimeout(window.__contentHubBootFailSafe);
